...
**jj absorb** \[**-f**\|**\--from**\] \[**-R**\|**\--repository**\] \[**\--ignore-working-copy**\] \[**-t**\|**\--into**\] \[**\--no-integrate-operation**\] \[**\--ignore-immutable**\] \[**\--at-operation**\] \[**\--debug**\] \[**\--color**\] \[**\--quiet**\] \[**\--no-pager**\] \[**\--config**\] \[**\--config-file**\] \[**-h**\|**\--help**\] \[*FILESETS*\]
