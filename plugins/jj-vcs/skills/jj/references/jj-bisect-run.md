...
**jj bisect run** \<**-r**\|**\--range**\> \[**-R**\|**\--repository**\] \[**\--ignore-working-copy**\] \[**\--find-good**\] \[**\--no-integrate-operation**\] \[**\--ignore-immutable**\] \[**\--at-operation**\] \[**\--debug**\] \[**\--color**\] \[**\--quiet**\] \[**\--no-pager**\] \[**\--config**\] \[**\--config-file**\] \[**-h**\|**\--help**\] \[*COMMAND*\] \[*ARGS*\]
