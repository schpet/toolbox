...
jj-bookmark-set - Create a new bookmark, or update an existing one by name

# SYNOPSIS

**jj bookmark set** \[**-r**\|**\--revision**\] \[**-R**\|**\--repository**\] \[**-B**\|**\--allow-backwards**\] \[**\--ignore-working-copy**\] \[**\--no-integrate-operation**\] \[**\--ignore-immutable**\] \[**\--at-operation**\] \[**\--debug**\] \[**\--color**\] \[**\--quiet**\] \[**\--no-pager**\] \[**\--config**\] \[**\--config-file**\] \[**-h**\|**\--help**\] \<*NAMES*\>
