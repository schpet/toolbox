...
**jj commit** \[**-i**\|**\--interactive**\] \[**-R**\|**\--repository**\] \[**\--ignore-working-copy**\] \[**\--tool**\] \[**-m**\|**\--message**\] \[**\--no-integrate-operation**\] \[**\--editor**\] \[**\--ignore-immutable**\] \[**\--at-operation**\] \[**\--debug**\] \[**\--color**\] \[**\--quiet**\] \[**\--no-pager**\] \[**\--config**\] \[**\--config-file**\] \[**-h**\|**\--help**\] \[*FILESETS*\]
