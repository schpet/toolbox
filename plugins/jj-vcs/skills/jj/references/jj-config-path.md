...
**jj config path** \[**-R**\|**\--repository**\] \[**\--user**\] \[**\--ignore-working-copy**\] \[**\--repo**\] \[**\--no-integrate-operation**\] \[**\--workspace**\] \[**\--ignore-immutable**\] \[**\--at-operation**\] \[**\--debug**\] \[**\--color**\] \[**\--quiet**\] \[**\--no-pager**\] \[**\--config**\] \[**\--config-file**\] \[**-h**\|**\--help**\]
