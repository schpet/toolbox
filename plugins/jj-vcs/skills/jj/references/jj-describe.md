...
jj-describe - Update the change description or other metadata \[default alias: desc\]

# SYNOPSIS

**jj describe** \[**-R**\|**\--repository**\] \[**\--ignore-working-copy**\] \[**-m**\|**\--message**\] \[**\--no-integrate-operation**\] \[**\--stdin**\] \[**\--ignore-immutable**\] \[**\--at-operation**\] \[**\--editor**\] \[**\--debug**\] \[**\--color**\] \[**\--quiet**\] \[**\--no-pager**\] \[**\--config**\] \[**\--config-file**\] \[**-h**\|**\--help**\] \[*REVSETS*\]

# DESCRIPTION

Update the change description or other metadata \[default alias: desc\]

Starts an editor to let you edit the description of changes. The editor will be \$EDITOR, or \`nano\` if thats not defined (\`Notepad\` on Windows).
