...
**jj duplicate** \[**-R**\|**\--repository**\] \[**\--ignore-working-copy**\] \[**-o**\|**\--onto**\] \[**-A**\|**\--insert-after**\] \[**\--no-integrate-operation**\] \[**-B**\|**\--insert-before**\] \[**\--ignore-immutable**\] \[**\--at-operation**\] \[**\--debug**\] \[**\--color**\] \[**\--quiet**\] \[**\--no-pager**\] \[**\--config**\] \[**\--config-file**\] \[**-h**\|**\--help**\] \[*REVSETS*\]
