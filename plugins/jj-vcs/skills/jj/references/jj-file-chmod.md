...
jj-file-chmod - Sets or removes the executable bit for paths in the repo

# SYNOPSIS

**jj file chmod** \[**-r**\|**\--revision**\] \[**-R**\|**\--repository**\] \[**\--ignore-working-copy**\] \[**\--no-integrate-operation**\] \[**\--ignore-immutable**\] \[**\--at-operation**\] \[**\--debug**\] \[**\--color**\] \[**\--quiet**\] \[**\--no-pager**\] \[**\--config**\] \[**\--config-file**\] \[**-h**\|**\--help**\] \<*MODE*\> \<*FILESETS*\>
