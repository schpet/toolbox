...
**jj git fetch** \[**-b**\|**\--branch**\] \[**-R**\|**\--repository**\] \[**\--ignore-working-copy**\] \[**\--no-integrate-operation**\] \[**\--tracked**\] \[**\--ignore-immutable**\] \[**\--remote**\] \[**\--all-remotes**\] \[**\--at-operation**\] \[**\--debug**\] \[**\--color**\] \[**\--quiet**\] \[**\--no-pager**\] \[**\--config**\] \[**\--config-file**\] \[**-h**\|**\--help**\]
