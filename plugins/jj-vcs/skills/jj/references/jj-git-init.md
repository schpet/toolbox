...
**jj git init** \[**\--colocate**\] \[**-R**\|**\--repository**\] \[**\--ignore-working-copy**\] \[**\--no-colocate**\] \[**\--git-repo**\] \[**\--no-integrate-operation**\] \[**\--ignore-immutable**\] \[**\--at-operation**\] \[**\--debug**\] \[**\--color**\] \[**\--quiet**\] \[**\--no-pager**\] \[**\--config**\] \[**\--config-file**\] \[**-h**\|**\--help**\] \[*DESTINATION*\]
