...
jj-git-remote-add - Add a Git remote

# SYNOPSIS

**jj git remote add** \[**\--fetch-tags**\] \[**-R**\|**\--repository**\] \[**\--ignore-working-copy**\] \[**\--push-url**\] \[**\--no-integrate-operation**\] \[**\--ignore-immutable**\] \[**\--at-operation**\] \[**\--debug**\] \[**\--color**\] \[**\--quiet**\] \[**\--no-pager**\] \[**\--config**\] \[**\--config-file**\] \[**-h**\|**\--help**\] \<*REMOTE*\> \<*URL*\>
...
**\--fetch-tags** *\<FETCH_TAGS\>* \[default: included\]
