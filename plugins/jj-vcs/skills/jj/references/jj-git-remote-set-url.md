...
jj-git-remote-set-url - Set the URL of a Git remote

# SYNOPSIS

**jj git remote set-url** \[**\--push**\] \[**-R**\|**\--repository**\] \[**\--fetch**\] \[**\--ignore-working-copy**\] \[**\--no-integrate-operation**\] \[**\--ignore-immutable**\] \[**\--at-operation**\] \[**\--debug**\] \[**\--color**\] \[**\--quiet**\] \[**\--no-pager**\] \[**\--config**\] \[**\--config-file**\] \[**-h**\|**\--help**\] \<*REMOTE*\> \[*URL*\]
