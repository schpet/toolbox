...
**jj git remote** \[**-R**\|**\--repository**\] \[**\--ignore-working-copy**\] \[**\--no-integrate-operation**\] \[**\--ignore-immutable**\] \[**\--at-operation**\] \[**\--debug**\] \[**\--color**\] \[**\--quiet**\] \[**\--no-pager**\] \[**\--config**\] \[**\--config-file**\] \[**-h**\|**\--help**\] \<*subcommands*\>
...
jj-git-remote-list(1)

:   List Git remotes

jj-git-remote-remove(1)

:   Remove a Git remote and forget its bookmarks

jj-git-remote-rename(1)

:   Rename a Git remote

jj-git-remote-set-url(1)
