...
jj-help - Print this message or the help of the given subcommand(s)

# SYNOPSIS

**jj help** \[**-k**\|**\--keyword**\] \[**-R**\|**\--repository**\] \[**\--ignore-working-copy**\] \[**\--no-integrate-operation**\] \[**\--ignore-immutable**\] \[**\--at-operation**\] \[**\--debug**\] \[**\--color**\] \[**\--quiet**\] \[**\--no-pager**\] \[**\--config**\] \[**\--config-file**\] \[**-h**\|**\--help**\] \[*COMMAND*\]
...
:   Show help for keywords instead of commands\
    ...
    *Possible values:*
    ...
    - bookmarks: Named pointers to revisions (similar to Gits branches)
