...
**jj new** \[**-R**\|**\--repository**\] \[**\--ignore-working-copy**\] \[**-m**\|**\--message**\] \[**\--no-edit**\] \[**\--no-integrate-operation**\] \[**\--ignore-immutable**\] \[**-A**\|**\--insert-after**\] \[**\--at-operation**\] \[**-B**\|**\--insert-before**\] \[**\--debug**\] \[**\--color**\] \[**\--quiet**\] \[**\--no-pager**\] \[**\--config**\] \[**\--config-file**\] \[**-h**\|**\--help**\] \[*REVSETS*\]
