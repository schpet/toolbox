...
jj-next - Move the working-copy commit to the child revision

# SYNOPSIS

**jj next** \[**-e**\|**\--edit**\] \[**-R**\|**\--repository**\] \[**\--ignore-working-copy**\] \[**-n**\|**\--no-edit**\] \[**\--conflict**\] \[**\--no-integrate-operation**\] \[**\--ignore-immutable**\] \[**\--at-operation**\] \[**\--debug**\] \[**\--color**\] \[**\--quiet**\] \[**\--no-pager**\] \[**\--config**\] \[**\--config-file**\] \[**-h**\|**\--help**\] \[*OFFSET*\]
...
:   Instead of creating a new working-copy commit on top of the target commit (like \`jj new\`), edit the target commit directly (like \`jj edit\`)
