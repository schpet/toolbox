...
jj-operation-restore - Create a new operation that restores the repo to an earlier state

# SYNOPSIS

**jj operation restore** \[**-R**\|**\--repository**\] \[**\--what**\] \[**\--ignore-working-copy**\] \[**\--no-integrate-operation**\] \[**\--ignore-immutable**\] \[**\--at-operation**\] \[**\--debug**\] \[**\--color**\] \[**\--quiet**\] \[**\--no-pager**\] \[**\--config**\] \[**\--config-file**\] \[**-h**\|**\--help**\] \<*OPERATION*\>
...
**\--what** *\<WHAT\>* \[default: repo,remote-tracking\]
...
:   What portions of the local state to restore (can be repeated)
    ...
    *Possible values:*
    ...
    - remote-tracking: The remote-tracking bookmarks. Do not restore these if youd like to push after the undo
