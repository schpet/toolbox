...
**jj rebase** \[**-b**\|**\--branch**\] \[**-R**\|**\--repository**\] \[**\--ignore-working-copy**\] \[**-s**\|**\--source**\] \[**\--no-integrate-operation**\] \[**-r**\|**\--revision**\] \[**\--ignore-immutable**\] \[**-o**\|**\--onto**\] \[**-A**\|**\--insert-after**\] \[**\--at-operation**\] \[**-B**\|**\--insert-before**\] \[**\--debug**\] \[**\--color**\] \[**\--skip-emptied**\] \[**\--keep-divergent**\] \[**\--quiet**\] \[**\--no-pager**\] \[**\--simplify-parents**\] \[**\--config**\] \[**\--config-file**\] \[**-h**\|**\--help**\]
