...
**jj restore** \[**-f**\|**\--from**\] \[**-R**\|**\--repository**\] \[**\--ignore-working-copy**\] \[**-t**\|**\--into**\] \[**-c**\|**\--changes-in**\] \[**\--no-integrate-operation**\] \[**\--ignore-immutable**\] \[**\--at-operation**\] \[**-i**\|**\--interactive**\] \[**\--debug**\] \[**\--tool**\] \[**\--color**\] \[**\--restore-descendants**\] \[**\--quiet**\] \[**\--no-pager**\] \[**\--config**\] \[**\--config-file**\] \[**-h**\|**\--help**\] \[*FILESETS*\]
