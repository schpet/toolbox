...
**jj sign** \[**-r**\|**\--revision**\] \[**-R**\|**\--repository**\] \[**\--ignore-working-copy**\] \[**\--key**\] \[**\--no-integrate-operation**\] \[**\--ignore-immutable**\] \[**\--at-operation**\] \[**\--debug**\] \[**\--color**\] \[**\--quiet**\] \[**\--no-pager**\] \[**\--config**\] \[**\--config-file**\] \[**-h**\|**\--help**\]
