...
jj-sparse-set - Update the patterns that are present in the working copy

# SYNOPSIS

**jj sparse set** \[**\--add**\] \[**-R**\|**\--repository**\] \[**\--ignore-working-copy**\] \[**\--remove**\] \[**\--clear**\] \[**\--no-integrate-operation**\] \[**\--ignore-immutable**\] \[**\--at-operation**\] \[**\--debug**\] \[**\--color**\] \[**\--quiet**\] \[**\--no-pager**\] \[**\--config**\] \[**\--config-file**\] \[**-h**\|**\--help**\]
