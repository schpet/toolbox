...
jj-util - Infrequently used commands such as for generating shell completions

# SYNOPSIS

**jj util** \[**-R**\|**\--repository**\] \[**\--ignore-working-copy**\] \[**\--no-integrate-operation**\] \[**\--ignore-immutable**\] \[**\--at-operation**\] \[**\--debug**\] \[**\--color**\] \[**\--quiet**\] \[**\--no-pager**\] \[**\--config**\] \[**\--config-file**\] \[**-h**\|**\--help**\] \<*subcommands*\>
...
jj-util-completion(1)

:   Print a command-line-completion script

jj-util-config-schema(1)
...
jj-util-install-man-pages(1)

:   Install Jujutsus manpages to the provided path

jj-util-markdown-help(1)
