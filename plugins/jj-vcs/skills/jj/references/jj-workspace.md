...
**jj workspace** \[**-R**\|**\--repository**\] \[**\--ignore-working-copy**\] \[**\--no-integrate-operation**\] \[**\--ignore-immutable**\] \[**\--at-operation**\] \[**\--debug**\] \[**\--color**\] \[**\--quiet**\] \[**\--no-pager**\] \[**\--config**\] \[**\--config-file**\] \[**-h**\|**\--help**\] \<*subcommands*\>

# DESCRIPTION

Commands for working with workspaces

Workspaces let you add additional working copies attached to the same repo. A common use case is so you can run a slow build or test in one workspace while youre continuing to write code in another workspace.
...
:   Stop tracking a workspaces working-copy commit in the repo

jj-workspace-list(1)

:   List workspaces

jj-workspace-rename(1)
